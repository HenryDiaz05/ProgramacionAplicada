...
#otro ejemplo de comprimir listas en un diccionario
...
print("After: ", plays)
#como key o clave tambien podemos tener un diccionario pero no se puede tener como tipo a un
# diccionario como se ve en library2
library = {"The Best Songs": plays, "The best movie": {"intelestelar":2, "taxi driver":4}}
print(library)
##library2 = {plays: 2, "Sunday Feelings": {}}